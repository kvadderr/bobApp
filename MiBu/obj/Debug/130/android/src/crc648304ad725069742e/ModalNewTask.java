...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MiBu.ModalNewTask, MiBu", ModalNewTask.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ModalNewTask.class) {
			mono.android.TypeManager.Activate ("MiBu.ModalNewTask, MiBu", "", this, new java.lang.Object[] {  });
		}
	}
