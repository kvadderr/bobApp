...
public class ModalNewDescription
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MiBu.ModalNewDescription, MiBu", ModalNewDescription.class, __md_methods);
	}


	public ModalNewDescription ()
	{
		super ();
		if (getClass () == ModalNewDescription.class) {
			mono.android.TypeManager.Activate ("MiBu.ModalNewDescription, MiBu", "", this, new java.lang.Object[] {  });
		}
	}
