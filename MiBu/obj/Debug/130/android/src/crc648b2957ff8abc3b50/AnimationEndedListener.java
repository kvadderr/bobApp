...
public class AnimationEndedListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Zebble.AnimationEndedListener, Zebble", AnimationEndedListener.class, __md_methods);
	}


	public AnimationEndedListener ()
	{
		super ();
		if (getClass () == AnimationEndedListener.class) {
			mono.android.TypeManager.Activate ("Zebble.AnimationEndedListener, Zebble", "", this, new java.lang.Object[] {  });
		}
	}
