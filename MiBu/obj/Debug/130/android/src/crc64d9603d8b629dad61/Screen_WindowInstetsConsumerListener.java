...
public class Screen_WindowInstetsConsumerListener
	extends crc64d9603d8b629dad61.Screen_AwaitableListener
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Zebble.Device.Screen+WindowInstetsConsumerListener, Zebble", Screen_WindowInstetsConsumerListener.class, __md_methods);
	}


	public Screen_WindowInstetsConsumerListener ()
	{
		super ();
		if (getClass () == Screen_WindowInstetsConsumerListener.class) {
			mono.android.TypeManager.Activate ("Zebble.Device.Screen+WindowInstetsConsumerListener, Zebble", "", this, new java.lang.Object[] {  });
		}
	}
